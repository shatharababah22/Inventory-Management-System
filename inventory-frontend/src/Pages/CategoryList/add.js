    ...
    <div style={{ display: 'flex', alignItems: 'center' }}>
      ...
      {newImageUrl && (
        <div style={{ marginRight: '10px' }}>
          <img src={newImageUrl} alt="New Category" style={{ maxWidth: '250px', maxHeight: '250px' }} />
        </div>
      )}
      ...
      <div className="custom-file">
        ...
        />
        <label className="custom-file-label with-border" htmlFor="image">Choose file</label>
      </div>
    </div>
  </div>
</div>
